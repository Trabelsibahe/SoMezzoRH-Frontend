    ...
    <div className="Nav">
      <nav className="navbar">
        ...
        <div className="navbar_item">
          ...
          <IconButton sx={{color:"black"}} className="navbar_toggle" onClick={toggleSidebar}> {showSidebar ? <CloseIcon  icon={CloseIcon}/> : <MenuIcon  icon={MenuIcon}/>}</IconButton>
        </div>     
...
{user.role === 'EXPERT'? (<li><a href="/expertrh" className="sidebar_item"><DashboardOutlinedIcon/> Mon espace</a></li>) :
 ...
 user.role === "RRH" ? (<li><a href="/rrh" className="sidebar_item">Mon espace</a></li>) : null }
        ...
        <li className="sidebar_logout" onClick={LogoutHandler}><span className="sidebar_item"><BiLogOut className="logout_icon"/>{" "}Déconnexion</span></li>
